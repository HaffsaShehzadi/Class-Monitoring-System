...
export default function SignUpScreen({ onBack, onSignUp }: { onBack: () => void, onSignUp: () => void }) {
  ...
  const roles = ['Admin', 'Monitoring Official', 'Teacher'];
  ...
  const handleSignUp = () => {
    ...
    // Department sirf Teacher ke liye zaroori hai
  ...
  const cycleRole = () => {
    ...
    // Agar role Teacher nahi hai to department clear kar do
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TextInput style={styles.input} placeholder="your.email@example.com" keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail} />

        <Text style={styles.label}>Password *</Text>
        <TextInput style={styles.input} placeholder="Enter password (min 6 characters)" secureTextEntry value={password} onChangeText={setPassword} />
...
const styles = StyleSheet.create({
  ...
  formContainer: { padding: 20, paddingTop: 30 },
