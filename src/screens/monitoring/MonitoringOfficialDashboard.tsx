...
// ✅ LOCAL info (App.tsx se nahi)
const MONITOR_INFO = { name: 'Ahmed Hassan' };

export default function MonitoringOfficialDashboard({ onNavigate, onLogout }: any) {
  const menuItems = [
    { id: 'viewAssignDuty', title: 'View Assign Duty', description: 'See your duty assignments' },
    { id: 'markAttendance', title: 'Mark Attendance', description: 'Mark class attendance' },
    { id: 'monitoringAttendanceHistory', title: 'Attendance History', description: 'View attendance records' },
  ];
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Welcome, {MONITOR_INFO.name}</Text>
        </View>
